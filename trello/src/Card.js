...
export default class Card extends React.Component {
    ...
    render() {
        return (
          <div>
          <button
            onClick={() => this.openModal('EditCard', this.props.title, this.props.name)}
            id='BtnActions'
          >
            Edit text
          </button>
          <button className="square" id="cardTitle" onDoubleClick={() => this.openModal('EditCard', this.props.title, this.props.name)}>
            {this.props.name}
          </button>
